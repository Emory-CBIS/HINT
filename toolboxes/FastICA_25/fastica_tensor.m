function [Out1, Out2, Out3,Out4,Out5] = fastica_tensor(mixedsig, varargin)
...
if only > 2
  ...
  [A, W,A_tilde_tensor,C_tensor] = fpica_tensor(whitesig,  whiteningMatrix, dewhiteningMatrix, approach, ...
