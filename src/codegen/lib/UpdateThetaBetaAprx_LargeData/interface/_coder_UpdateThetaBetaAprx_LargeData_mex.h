 ...
 *
 * _coder_UpdateThetaBetaAprx_LargeData_mex.h
 *
 * Code generation for function '_coder_UpdateThetaBetaAprx_LargeData_mex'
 *
 */

#ifndef _CODER_UPDATETHETABETAAPRX_LARGEDATA_MEX_H
#define _CODER_UPDATETHETABETAAPRX_LARGEDATA_MEX_H
...
/* End of code generation (_coder_UpdateThetaBetaAprx_LargeData_mex.h) */
