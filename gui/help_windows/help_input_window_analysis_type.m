function help_input_window_analysis_type()

    % Check if an instance of helpInputWindowAnalysisType already running
    hs = findall(0,'tag','helpInputWindowAnalysisType');
    if (isempty(hs))
    ...
    function hs = add_help_input_window_analysis_type_components
        ...
        hs.fig = figure('Tag','helpInputWindowAnalysisType',...
            'units', 'normalized', 'position', [0.4 0.4 0.2 0.3],...
            'MenuBar', 'none',...
            'NumberTitle','off',...
            'Name','Analysis Type - Help',...
            'Resize','off',...
            'Visible','off',...
            'Color',get(0,'defaultUicontrolBackgroundColor'),...
            'WindowStyle', 'modal');
        
        helpString = fileread('help_input_window_analysis_type_text1.txt');
