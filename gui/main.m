...
% See also: hcica
    ...
    function hs = addcomponents
        ...
        t2text3 = uicontrol('Parent',t2p1,'Style','text',...
            'units', 'normalized','Position',[0.01, 0.4, 0.45, 0.1],...
            'String','Global Parameter','FontSize',myfont,...
            'HorizontalAlignment','right'); %#ok<NASGU>
        ...
        t2text4 = uicontrol('Parent',t2p1,'Style','text',...
            'units', 'normalized','Position',[0.01, 0.25, 0.45, 0.1],...
            'String','Local Parameter','FontSize',myfont,...
            'HorizontalAlignment','right'); %#ok<NASGU>
